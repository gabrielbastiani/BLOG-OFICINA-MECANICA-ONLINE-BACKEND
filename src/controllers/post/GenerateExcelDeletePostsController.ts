...
import { GenerateExcelDeletePostsService } from '../../services/post/GenerateExcelDeletePostsService'; 
...
class GenerateExcelDeletePostsController {
    async handle(req: Request, res: Response) {
        ...
        try {
            const generateExcelService = new GenerateExcelDeletePostsService();
...
export { GenerateExcelDeletePostsController };